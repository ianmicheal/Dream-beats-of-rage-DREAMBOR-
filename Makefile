...
INCLUDES        = $(KOS_BASE)/../kos-ports/include/SDL \
                  ...
                  $(KOS_BASE)/../kos-ports/include/ogg \
				  $(KOS_BASE)/../kos-ports/include/vorbis/include
ifeq ($(BUILD_DC), 0)
BUILD_DEBUG     = 0
endif
endif
...
ifndef BUILD_DEBUG
ifdef BUILD_DC
CFLAGS 	       += -Os -fsingle-precision-constant -fomit-frame-pointer  -DNO_RAM_DEBUGGER -ffast-math
else
CFLAGS 	       +=
endif
CFLAGS 	       +=
...
CFLAGS         += -DNO_RAM_DEBUGGER -o1 -funroll-loops -fsingle-precision-constant -fomit-frame-pointer
endif
endif
...
ifdef BUILD_DC
LIBS           += -lSDL_1213DH -ltremor  -lkosfat -lz -lm 
endif
...
KOS_LOCAL_CFLAGS = -I$(KOS_BASE)/../kos-ports/include -ml -m4-single-only -Os -ffast-math
